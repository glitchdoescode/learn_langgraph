...
- [ ] Master StateGraph fundamentals: nodes, edges, and state (docs: https://langchain-ai.github.io/langgraph/concepts/low_level/)
- [ ] Understand graph compilation and configuration (docs: https://langchain-ai.github.io/langgraph/concepts/low_level/#compiling-your-graph)
- [ ] Define and work with State schemas and reducers (docs: https://langchain-ai.github.io/langgraph/concepts/low_level/#state)
- [ ] Implement nodes as Python functions with proper signatures (docs: https://langchain-ai.github.io/langgraph/concepts/low_level/#nodes)
- [ ] Create normal and conditional edges for control flow (docs: https://langchain-ai.github.io/langgraph/concepts/low_level/#edges)
- [ ] Use START and END nodes for graph entry/exit points (docs: https://langchain-ai.github.io/langgraph/concepts/low_level/#start-node)
- [ ] Implement Send API for dynamic map-reduce patterns (docs: https://langchain-ai.github.io/langgraph/concepts/low_level/#send)
